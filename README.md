...
Windows comes pre-loaded with apps that are more interested in selling you things than doing their job. The programs below are replacements that share a common thread: open source or at least privacy-respecting, no upsell popups, and they just *do the thing*.
